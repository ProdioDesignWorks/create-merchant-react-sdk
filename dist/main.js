...
var PaymentProcessor = function (_Component) {
  ...
  _createClass(PaymentProcessor, [{
    ...
    value: function stepMoveAllowed() {
      ...
      if (this.props.dontValidate) {
        ...
        if (skipValidationExecution) {
          ...
          // the user is using a higer order component (HOC) for validation (e.g react-validation-mixin), this wraps the FormBuilder steps as a HOC,
    ...
    // main render of FormBuilder container
